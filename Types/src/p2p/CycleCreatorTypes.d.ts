...
export declare type CycleTxs = SafetyMode.Txs & Refresh.Txs & Archivers.Txs & Join.Txs & Active.Txs & Apoptosis.Txs & Lost.Txs & Rotation.Txs & CycleAutoScale.Txs;
export declare type CycleRecord = BaseRecord & SafetyMode.Record & Refresh.Record & Archivers.Record & Join.Record & Active.Record & Apoptosis.Record & Lost.Record & Rotation.Record & {
    joined: string[];
    returned: string[];
    lost: string[];
    refuted: string[];
    apoptosized: string[];
} & Snapshot.Record & CycleAutoScale.Record;
