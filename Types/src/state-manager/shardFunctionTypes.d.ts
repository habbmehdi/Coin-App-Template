 ...
 */
declare type WrappableParitionRange = {
    /**
 ...
 * A range of addresses
 */
declare type HomeNodeSummary = {
    edge: string[];
    consensus: string[];
    storedFull: string[];
    noExtendedData?: boolean;
};
declare type ParititionShardDataMap = Map<number, ShardInfo>;
declare type NodeShardDataMap = Map<string, NodeShardData>;
